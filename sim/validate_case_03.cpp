...
int main() {
    std::printf("Running NESC Atmospheric Check Case 3...\n");
    ...
    using Vehicle = sim::vehicles::BrickVehicleDamped;
    using Loads   = sim::loads::Case3Loads<Vehicle>;
    ...
    std::filesystem::path out_dir =
        "./sim/validation/nesc_cases/case_03/sim_results_csv";
    sim::numerical_methods::rk4(model, x, t_s, h_s, &aux_log);
    sim::utils::export_to_csv(x, t_s, aux_log, out_dir, "sim_data_03.csv");
